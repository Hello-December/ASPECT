...
def ukf_infer():
    # 替换所有 \ 为 /，支持跨平台，无转义错误
    pred_poses_path = r"./files/rot_speed_analysis/test_refiner_v1.1_train_3_random_light_0.1_60_0.08_0.1_1000_v2_2000imgs_v12/pred_rot_euler_cache.npy"
    ...
    project_root = "./"
    output_dir = os.path.join(project_root, "files", "ukf_result", "normal", subdirectory_name)
